...
class AccountResource extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            return back()->with('flash_error',  trans('admin.Account Manager Not Found'));
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('admin.account-manager.index')->with('flash_success',trans('admin.editMessageSuccess'));
        } 
