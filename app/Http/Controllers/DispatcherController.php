        ...
        try {
            ...
            if(Auth::guard('admin')->user()){
                return redirect()
                        ...
                        ->with('flash_success', trans('admin.Request Assigned to Provider'));
            ...
            if(Auth::guard('admin')->user()){
                return redirect()->route('admin.dispatcher.index')->with('flash_error', trans('admin.Something Went Wrong'));
            }elseif(Auth::guard('dispatcher')->user()){
                return redirect()->route('dispatcher.index')->with('flash_error', trans('admin.Something Went Wrong'));
            }
        }
    }
            ...
            if($request->has('provider_auto_assign')) {
                ...
                if(count($Providers) == 0) {
                    if($request->ajax()) {
                        ...
                        return back()->with('flash_success', trans('admin.Provider Not Found'));
                    }
                }
