...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;">@lang('admin.add_car')</h5>

            <form class="form-horizontal" action="{{route('admin.order.store')}}" method="POST" enctype="multipart/form-data" role="form">
                {{csrf_field()}}

                <div class="form-group input_us">
                    <label>{{__('admin.borr')}}</label><span class="color_red">*</span>
                    <select name="id_borr" class="form-control" id="country">
                        @isset($users)
                    ...
                    <div class="col-md-6">
                        <div class="form-group group">
                            <div class="text-group">
                                ...
                                <textarea required="required"name="note_ar" class="form-control" rows="9" id="myeditor">{{old('note_ar')}} </textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="form-group btn_div row">
                    ...
                    <div class="col-xs-10">
                        <button type="submit" class="btn btn-primary">@lang('admin.add_car')</button>
