                ...
                <form action="{{url('profile')}}" method="post" enctype="multipart/form-data">
                            ...
                            @if(auth()->user()->picture != null)
                                <div class="img_outer">
                                    <img class="profile_preview" id="profile_image_preview"
                                         src="{{asset(auth()->user()->picture)}}" alt="your image"/>
                                </div>
                            @else
                                <div class="img_outer">
                                    <img class="profile_preview" id="profile_image_preview"
                                         src="{{asset('asset/img/provider.jpg')}}" alt="your image"/>
                                </div>
                            @endif
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="first_name" required
                               placeholder="@lang('user.profile.first_name')" value="{{base64_decode(Auth::user()->first_name)}}">
                    </div>

                    <div class="form-group col-md-6">
                        <label>@lang('user.profile.last_name')</label>
                        <input type="text" class="form-control" name="last_name" required
                               placeholder="@lang('user.profile.last_name')" value="{{base64_decode(Auth::user()->last_name)}}">
                    </div>

                    <div class="form-group col-md-6">
                        <label>@lang('user.profile.email')</label>
                        <input type="email" class="form-control" name="email" placeholder="@lang('user.profile.email')" readonly
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="mobile" required
                               placeholder="@lang('user.profile.mobile')" value="{{Auth::user()->mobile}}">
                    </div>
