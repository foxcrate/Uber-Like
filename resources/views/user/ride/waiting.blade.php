				...
				return (
					<form action="{{url('cancel/ride')}}" method="POST">
			            ...
			            <div className="status">
			                ...
			                <p>@lang('user.finding_driver')</p>
			            </div>

		            	<button type="submit" className="full-primary-btn fare-btn">@lang('user.cancel_request')</button>
		            </form>
				);
			}
		});
			...
			render: function(){
				return (
					...
					<input type="hidden" name="request_id" value={this.props.checkState.id} />
						<div className="status">
			                <h6>@lang('user.status')</h6>
			                <p>@lang('user.accepted_ride')</p>
			            </div>
			            <CancelReason/>
		            	<button type="button" className="full-primary-btn" data-toggle="modal" data-target="#cancel-reason">@lang('user.cancel_request')</button>
		            	<br/>
		            		<h5><strong>@lang('user.driver_detals')</strong></h5>
		...
		var DroppedAndCash = React.createClass({
			...
			render: function(){
				...
				<div>
					<div className="status">
		                <h6>@lang('user.status')</h6>
		                <p>@lang('user.dropped_ride')</p>
		            </div>
		            <br/>
		            	<h5><strong>@lang('user.ride_detals')</strong></h5>
		            	<dl className="dl-horizontal left-right">
		            		<dt>@lang('user.booking_id')</dt>
				            <dd>{this.props.checkState.booking_id}</dd>
		            		<dt>@lang('user.driver_name')</dt>
			...
			render: function(){
				...
				{{ csrf_field() }}</input>
                    <div className="rate-review">
                        <label>@lang('user.rating')</label>
                        <div className="rating-outer">
                            <input type="hidden" value="1" name="rating" className="rating"/>
                        </div>
						<input type="hidden" name="request_id" value={this.props.checkState.id} />
                        <label>@lang('user.comment')</label>
