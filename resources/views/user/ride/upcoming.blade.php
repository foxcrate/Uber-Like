                                                ...
                                                <div class="my-trip-left">
                                                    ...
                                                    <div class="from-to row no-margin">
                                                        <div class="from">
                                                            ...
                                                            <p>{{$trip->s_address_ar}}</p>
                                                        </div>
                                                        <div class="to">
                                                            <h5>@lang('user.to')</h5>
                                                            <p>{{$trip->d_address_ar}}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="fare-break">
                                                    ...
                                                    <form method="POST" action="{{url('cancel/ride')}}">
                                                        ...
                                                        <button class="full-primary-btn fare-btn"
                                                                type="submit">@lang('user.Cancel_Ride')</button>
                                                    </form>
