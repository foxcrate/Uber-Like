...
<div class="col-md-9">
    <div class="dash-content">
        <div class="row no-margin">
            <div class="col-md-12">
                <h4 class="page-title">@lang('user.ride_now')</h4>
            </div>
        </div>
            ...
            <div class="col-md-6">
                ...
                {{ csrf_field() }}
                    ...
                    @if(1 == 1)
                        ...
                        <div class="surge-block"><span class="surge-text">1</span>
                        </div>
                    
                    @endif

                    <button type="submit" class="half-primary-btn fare-btn">@lang('user.ride_now')</button>
                    <button type="button" class="half-secondary-btn fare-btn" data-toggle="modal" data-target="#schedule_modal">@lang('user.Schedule Later')</button>
            ...
            <div class="col-md-6">
                <div class="user-request-map">
                    ...
                    <div class="from-to row no-margin">
                        <div class="from">
                            <h5>FROM</h5>
                            <p>{{$request->s_address_ar}}</p>
                        </div>
                        <div class="to">
                            <h5>TO</h5>
                            <p>{{$request->d_address_ar}}</p>
                        </div>
                    </div>
                </div> 
            </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">@lang('user.Schedule a Ride')</h4>
      </div>
      <form>
      <div class="modal-body">
        
        <label>@lang('user.Date')</label>
        <input value="{{date('m/d/Y')}}" type="text" id="datepicker" placeholder="{{trans('user.Date')}}" name="schedule_date">
        <label>@lang('user.Time')</label>
        <input value="{{date('H:i')}}" type="text" id="timepicker" placeholder="{{trans('user.Time')}}" name="schedule_time">

      </div>
      <div class="modal-footer">
        <button type="button" id="schedule_button" class="btn btn-default" data-dismiss="modal">@lang('user.Schedule a Ride')</button>
      </div>
