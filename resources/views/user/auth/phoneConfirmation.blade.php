                ...
                <div class="col-md-6 log-right">
                    <div class="login-box-outer">
                        <div class="login-box row no-margin">
                            ...
                            <div class="row">
                                <!-- -->
                                <h3 style="margin-top: 80px;">@lang('user.mobileConfirmationCode')</h3>
                           ...
                           <form id="theForm" action="{{ url('/register2_user') }}" method="post">
                                @csrf
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="input7" name="password" value="{{$user->password}}">
                                    <input type="hidden" id="input8" name="password_confirmation" value="{{$user->password_confirmation}}">
                                </div>
