...
{{--                    {{ csrf_field() }}--}}
                        ...
                        <div class="col-md-12">
                             <input id="email" type="text" class="form-control" placeholder="@lang('user.email_address') / @lang('user.mobile')" name="email" value="{{ old('email') }}"  autofocus>
...
{{--                    @endif--}}
                    ...
                    <div class="col-md-12">
                        <p class="helper"> <a href="{{ url(route('auth.resetUser')) }}">@lang('user.forget_pass')</a></p>
