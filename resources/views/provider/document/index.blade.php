...
{{--            <a href="#" class="pro-head-link active">@lang('user.Manage Documents')</a>--}}
...
{{--                                            <p class="license">@lang('user.Expires')--}}
{{--                                                : {{ $Provider->document($Document->id) ? $Provider->document($Document->id)->expires_at : 'N/A' }}</p>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">--}}
...
{{--                                                                            <i class="fa fa-upload upload-icon"></i> @lang('user.Upload')--}}
{{--                                                                        </span>--}}
