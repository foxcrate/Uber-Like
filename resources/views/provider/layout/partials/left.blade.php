<div class="col-md-3">
    <div class="dash-left">
        ...
        <div class="side-menu">
             <ul>
                <li><a class="active" href="{{ route('provider.index') }}">@lang('user.Home')</a></li>
                <li><a href="{{ route('provider.trips') }}">@lang('user.My Trips')</a></li>
                <li><a href="{{ route('provider.profile.show') }}">@lang('user.Profile')</a></li>
                <li>
