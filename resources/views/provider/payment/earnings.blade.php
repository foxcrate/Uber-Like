...
@section('content')
    <div class="pro-dashboard-head">
        <div class="container">
            <a href="{{url('provider/earnings')}}" class="pro-head-link active">@lang('user.Payment Statements')</a>
...
@endphp
    ...
    <div class="pro-dashboard-content">
        ...
        <div class="earning-head">
            <div class="container">
                <div class="earning-element">
                    <p class="earning-txt">@lang('user.TOTAL EARNINGS')</p>
                    <p class="earning-price" id="set_fully_sum">{{ currency($provider[0]->wallet_balance) }}</p>
                </div>
                <div class="earning-element row no-margin">
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                        <div class="earning-box">
                            ...
                            <p class="dashboard-txt">@lang('user.TRIPS COMPLETED TODAY')</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                        <div class="earning-box">
                            ...
                            <p class="dashboard-txt">@lang('user.DAILY TRIP TARGET') </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                        <div class="earning-box">
                            ...
                            <p class="dashboard-txt">@lang('user.FULLY COMPLETED TRIPS')</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                        <div class="earning-box">
                            ...
                            <p class="dashboard-txt">@lang('user.ACCEPTANCE RATE')</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-4">
                        <div class="earning-box">
                            ...
                            <p class="dashboard-txt">@lang('user.DRIVER CANCELLATIONS')</p>
                        </div>
                    </div>
        ...
        <div class="earning-content gray-bg">
            <div class="container">
                ...
                <div class="earning-section pad20 row no-margin">
                    <div class="earning-section-head">
                        <h3 class="earning-section-tit">@lang('user.Weekly Earnings')</h3>
                    </div>
                                ...
                                <div class="row no-margin">
                                    <div class="pull-left trip-left">
                                        <h3 data-toggle="collapse" data-target="#demo1"
                                            ...
                                            <span class="arrow-icon fa fa-chevron-right">
                                                @lang('user.Trip Earnings')
                                            </span>
                                        </h3>
                                    </div>
                                </div>
                ...
                <div class="earning-section earn-main-sec pad20">
                    ...
                    <div class="earning-section-head row no-margin">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 no-left-padding">
                            <h3 class="earning-section-tit">@lang('user.Daily Earnings')</h3>
                        </div>
                                    ...
                                    <form class="form-inline status-form">
                                        <div class="form-group">
                                            ...
                                            <select type="password" class="form-control mx-sm-3">
                                                <option>@lang('user.All Trips')</option>
                                                <option>@lang('user.Completed')</option>
                                                <option>@lang('user.Pending')</option>
                                            </select>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="list-view pad30 ">
                            ...
                            <table class="earning-table table table-responsive">
                                ...
                                <tr>
                                    ...
                                    <th>@lang('user.Booking Id')</th>
                                    <th>@lang('user.Vehicle')</th>
                                    <th>@lang('user.Duration')</th>
                                    <th>@lang('user.Status')</th>
                                    <th>@lang('user.Distance(KM)')</th>
                                    <th>@lang('user.Cash Collected')</th>
                                    <th>@lang('user.Total Earnings')</th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php $fully_sum = 0; ?>
            ...
            <!-- End of earning content -->
        </div>
    </div>
@endsection
@section('scripts')
    {{-- <script type="text/javascript">
        document.getElementById('set_fully_sum').textContent = "{{currency(15)}}";
    </script> --}}
@endsection
