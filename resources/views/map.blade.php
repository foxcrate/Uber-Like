...
<html lang="en">
  ...
  <body>
    ...
    <script>
      const KEY = "AIzaSyDznD1EOAUQ7nkhl16Q1jMZdaTA1NV-9wo";
      const LAT = 50.1;
      const LNG = -97.3;
      //let url = `https://maps.googleapis.com/maps/api/geocode/json?latlng=${LAT},${LNG}&key=${KEY}`;
      let url=  'https://maps.googleapis.com/maps/api/directions/json?origin=29.953214,29.945439997&destination=29.972,30.94389&sensor=false&key=AIzaSyDznD1EOAUQ7nkhl16Q1jMZdaTA1NV-9wo' ;
      fetch(url).then(console.log(response.json()));
